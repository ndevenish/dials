...
def generate_integrated_test_reflections():
    ...
    dials.integrate or dials.scale.

    This is a simple example with no partials or corrections, to test
    the correct selection of intensities.
    """
    r = flex.reflection_table()
...
def test_filtered_arrays_from_experiments_reflections():
    """Test the creating of a miller array from crystal and reflection
    table."""
...
def test_checks_in_reduce_data_for_export():
    """Test for graceful failures if serious problems with the data are
    found."""
...
def test_partial_summing_functions():
    ...
    Example is that of two reflections measured with 0.5 partiality,
    with I/sigma of 1 & 2.
    """
